"""cybersecurity_awareness URL Configuration
...
from cybersecurity_awareness import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Cybersecurity_Awarness_Type/$', remoteuser.Predict_Cybersecurity_Awarness_Type, name="Predict_Cybersecurity_Awarness_Type"),
    ...
    url(r'^View_Cybersecurity_Awareness_Ratio/$', serviceprovider.View_Cybersecurity_Awareness_Ratio, name="View_Cybersecurity_Awareness_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Prediction_Of_Cybersecurity_Awareness/$', serviceprovider.Prediction_Of_Cybersecurity_Awareness, name="Prediction_Of_Cybersecurity_Awareness"),
